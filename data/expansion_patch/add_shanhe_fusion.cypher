MATCH (e:Enterprise {id:'ENT_E1D3FB10F935'})
...
SET r3.confidence=0.74, r3.source='manual_expansion_patch_2026-05-12'
MERGE (e)-[r4:HAS_KEY_CAPABILITY]->(k1)
SET r4.confidence=0.76, r4.source='manual_expansion_patch_2026-05-12'
MERGE (e)-[r5:HAS_KEY_CAPABILITY]->(k2)
SET r5.confidence=0.74, r5.source='manual_expansion_patch_2026-05-12';
