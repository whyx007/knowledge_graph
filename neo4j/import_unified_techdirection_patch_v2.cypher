// TechDirection import patch v2

LOAD CSV WITH HEADERS FROM 'file:///unified_tech_directions_v2.csv' AS row
...
LOAD CSV WITH HEADERS FROM 'file:///unified_rel_techdirection_to_stage_v2.csv' AS row
